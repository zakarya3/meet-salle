                        ...
                        <div class="room_features mt-4">
                            ...
                            <ul class="list-unstyled">
                                ...
                                @if ($room->has_projector)
                                    <li><i class="fa fa-video-camera"></i> Projecteur</li>
                                @endif
                                @if ($room->has_wifi)
                                    <li><i class="fa fa-wifi"></i> Wifi</li>
                                @endif
                                @if ($room->has_ac)
                                    <li><i class="fa fa-snowflake-o"></i> Climatisation</li>
                                @endif
                            </ul>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="client_phone" class="form-control">
                                        </div>
                                    </div>
